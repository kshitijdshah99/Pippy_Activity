...
Basic principles taught were pygame introduction, dealing with shapes, pictures, text, and drawing graphics primitives.
Intermediate techniques included playing music and constructing a graphic user interface (GUI).
Advanced notions include creating an app, a basic board game, or even tiles for it.
